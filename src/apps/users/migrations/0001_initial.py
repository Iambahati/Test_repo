# Generated by Django 4.2.19 on 2025-02-07 10:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, 'Admin'), (2, 'Therapist'), (3, 'User')], default=3)),
                ('profile_image', models.CharField(blank=True, max_length=255, null=True)),
                ('email_verified_at', models.DateTimeField(null=True)),
                ('specializations', models.TextField(blank=True, help_text='Comma-separated list of specializations', null=True)),
