...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f'Starting Docker containers using {docker_compose_file}...'))
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS('Docker containers started successfully!'))
        except subprocess.CalledProcessError as e:
            self.stdout.write(self.style.ERROR(f'Error starting Docker containers: {e.stderr}'))